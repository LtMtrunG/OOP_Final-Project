                ...
                if (item.getId().equals(selected.getId())) {
                    if (item.getCopy() == 0) {
                        ...
                        if(LoginController.account instanceof VIPAccount & LoginController.account.getSuccessfullyReturn() == 10){
                            ...
                            alert.setTitle("Free Rent");

                            // Header Text: null
                            alert.setHeaderText(null);
                            alert.setContentText("You have earned 100 reward points or more. Do you want to change the reward point for a free rent?");
                            ...
                            if(option.get() == ButtonType.OK){
                                ...
                                alert1.setTitle("Rent Item");

                                // Header Text: null
                                alert1.setHeaderText(null);
                                alert1.setContentText("Successfully rent item for free!");
